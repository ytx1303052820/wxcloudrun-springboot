...
public class ImageController {
    ...
    public ResponseEntity<byte[]> getImage(@PathVariable String contactId,HttpServletRequest request) {
        try {
            // 获取图片的资源路径
            Resource resource = resourceLoader.getResource("classpath:static/contact/" +contactId+ ".jpg" );
